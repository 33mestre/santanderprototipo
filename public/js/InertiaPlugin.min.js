...
!(function (t, e) {
      ...
      return (
        ...
        (VelocityTracker.track = function track(e, n, r) {
          ...
          for (
            ...
            for (i = q(c[f]) || new VelocityTracker(c[f]), o = s.length; o--; )
              i.add(s[o], u[o] || u[0]);
            a.push(i);
          }
          return a;
  ...
  function aa(t, e, n, r, i, o) {
    ...
    if(((n = isNaN(n) ? R : n), (r = isNaN(r) ? -R : r), M(e))) {
      if(
        ((a = e.calculated ? e : (N(s) ? s(e) : _(e, s, n, r, o)) || e),
        !e.calculated)
      ) {
        for (c in a) e[c] = a[c];
        e.calculated = !0;
      ...
      for (i = 0; i < f.length; i++)
        (a = e[(o = f[i])]) &&
          ((c = L(a.velocity)
            ...
            ? s.get(o)
            : 0),
          (u = Math.abs(c / ba(a, "resistance", r))),
                  ...
                  S[a] ||
                    ...
                    M(c) &&
                      ...
                      "max" in c && l > +c.max + 1e-10
                        ? ((d = c.unitFactor || P.unitFactors[a] || 1),
                          (p =
                            (f > c.max && c.min !== c.max) ||
                            (-15 < u * d && u * d < 45)
                              ? r + 0.1 * (n - r)
        ...
        for (a in ((e = A), (A = 0), (d = fa(t, e, v, k)), e))
          S[a] ||
            ...
            M(c) &&
              ((p = s + l),
              "end" in c &&
                (c = aa(c, d && a in d ? d : p, c.max, c.min, a, e.radius)),
              "max" in c && +c.max < p
