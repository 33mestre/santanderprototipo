...
(function (factory) {
    ...
    function updateTransform(obj) {
        var _t = '';
if(isNaN(obj._jt_obj.scaleX)){
	obj._jt_obj.scaleX = 1;
        }
if(isNaN(obj._jt_obj.scaleY)){
	obj._jt_obj.scaleY = 1;
}
if(isNaN(obj._jt_obj.scaleZ)){
    ...
    extend(JT, {
        ...
        Quad: {
            ...
            EaseInOut: function (k) {
                 if((k /= 0.5) < 1) {return 0.5 * Math.pow(k,2);}
      			return -0.5 * ((k -= 2) * k - 2);
            },
             EaseIn: function (k) {
                  return Math.pow(k, 2);
        ...
        Elastic: {
            ...
            EaseOut: function (k) {
            	return .04 * k / (--k) * Math.sin(25 * k);
            	//var p = 0.1;
    			//return Math.pow(2,-10*t) * Math.sin((t-p/4)*(2*Math.PI)/p) + 1;
            }
            ,
            EaseIn: function (k) {
 				return (.04 - .04 / k) * Math.sin(25 * k) + 1;
            }
            ,
            EaseInOut: function (k) {
 				 return (k -= .5) < 0 ? (.01 + .01 / k) * Math.sin(50 * k) : (.02 - .01 / k) * Math.sin(50 * k) + 1;
            }
        },
        Back: {
            In: function (k) {
