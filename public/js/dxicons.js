var vitplayBrowser = navigator.userAgent.match(/VITPLAY/) != null;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var f = function (a) {
    //FIXME 
    for (var b = (window ? window.location.href : "").substr(0, 5) === 'file:' || -1 !== a.indexOf('localhost'), e = [d, 'localhost'], f = e.length; --f > -1;)
  ...
  k = _gsScope._gsDefine.plugin({
    ...
    init: function (a, g) {
      ...
      if (!f) {
        //return window.location.href = "http://" + d + e + "?plugin=" + c + "&source=" + b, !1;
      }
      var m, n, o, k = i(a) + 1;
...
(function (window, moduleName) {
  ...
  var TweenLite = _class("TweenLite", function (target, duration, vars) {
    ...
    if (target == null) {
      console.error('Cannot tween a null target.');
...
var easeSocialVar = Circ;
window['clearNightIcon'] = function (index, f, thisIcon) {
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".moon").node, 1, { scale: 0, transformOrigin: "50% 50%", ease: Elastic.easeOut })
    .timeScale(speed);
  animateStars(f, 6, tl, .4);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
function animateDash(tl, dashedGroup, speed, dash, gap, type) {
  ...
  for (var i = 0; i < dashedLines.length; i++) {
    ...
    tl.to(fakeTweenObj, speed, {
      ...
      onUpdateParams: [fakeTweenObj, dashedLines[i]],
      repeat: -1,
...
window['mysteryIcon'] = function (index, f, thisIcon) {
  //animate in animation
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".bottomSquare").node, .4, { scale: 0, transformOrigin: "top right", ease: easeSocialVar }, "-=.2")
    .from(f.select(".topSquare").node, .4, { scale: 0, transformOrigin: "bottom left", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
  tlsRollover[index] = tlRollover;
...
window['addthisIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".horiz").node, .4, { scaleX: 0, transformOrigin: "left", ease: easeSocialVar }, "-=.2")
    .from(f.select(".vert").node, .4, { scaleY: 0, transformOrigin: "top", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['amazonIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .to(thisPath.node, .4, { strokeDashoffset: 0, ease: easeSocialVar })
    .from(f.select(".arrow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.1")
    .from(f.select(".a").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
  tlsRollover[index] = tlRollover;
...
window['beboIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(thisPath.node, .6, { strokeDashoffset: -strokeMaskLength, ease: easeSocialVar })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['behanceIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".b").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.1")
    .from(f.select(".e").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".accent").node, .4, { scaleX: 0, transformOrigin: "left", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['bloggerIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".b").node, .8, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.4")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
  tlsRollover[index] = tlRollover;
...
window['deviantartIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".vert").node, .2, { scaleY: 0, transformOrigin: "top", ease: Quad.easeIn }, "-=.2")
    .from(thisPath1.node, .5, { strokeDashoffset: strokeMaskLength1, ease: Quad.easeOut })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['diggIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".d").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".i").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".g1").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".g2").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".iDot").node, .4, { scaleX: 0, transformOrigin: "left", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.5")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
  tlsRollover[index] = tlRollover;
}
window['dribbleIcon'] = function (index, f, thisIcon) {
  //animate in animation
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".ball").node, .5, { y: -30, alpha: 0, ease: Bounce.easeOut })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['dropboxIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".bl").node, .4, { alpha: 0, ease: easeSocialVar }, ".3")
    .from(f.select(".tl").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".tr").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".br").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".bottom").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".box").node, .8, { y: 20, ease: easeSocialVar }, "-=.8")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['evernoteIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".elephant").node, .4, { alpha: 0, ease: easeSocialVar })
    .from(f.select(".ear").node, .4, { scale: 0, transformOrigin: "right bottom", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['facebookIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".f").node, .5, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['flickrIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".circles").node, .3, { scale: 0, ease: easeSocialVar, transformOrigin: "50% 50%" }, "-=.1")
    .from(f.select(".circleR").node, .5, { x: -23, ease: easeVar.easeInOut }, ".4")
    .from(f.select(".circleL").node, .5, { x: 23, ease: easeVar.easeInOut }, ".4")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['forrstIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".tri").node, .4, { scale: 0, transformOrigin: "middle bottom", ease: easeSocialVar })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".trunk").node, .4, { scale: 0, transformOrigin: "middle bottom", ease: easeSocialVar }, "-=.3")
    .from(f.select(".branch1").node, .4, { scale: 0, transformOrigin: "left bottom", ease: easeSocialVar }, "-=.3")
    .from(f.select(".branch2").node, .4, { scale: 0, transformOrigin: "right bottom", ease: easeSocialVar }, "-=.3")
    .from(f.select(".branch3").node, .4, { scale: 0, transformOrigin: "left bottom", ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
  tlsRollover[index] = tlRollover;
...
window['githubIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".whiteCircle").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".gitLogo").node, .4, { scale: 0, transformOrigin: "50% 100%", ease: easeSocialVar })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['googleIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".gLetter").node, .4, { alpha: 0, ease: easeSocialVar })
    .from(f.select(".plusSign").node, .2, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['groovesharkIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".allGroove").node, .3, { scale: 0, ease: easeSocialVar, transformOrigin: "50% 50%" }, "-=.2")
    .from(f.select(".finGS").node, .6, { y: 50, ease: Quad.easeOut, transformOrigin: "50% 50%" }, "-=.1")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['instagramIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".camera").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".flash").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".lens").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['kickstarterIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(thisPath1.node, .4, { strokeDashoffset: strokeMaskLength1, ease: Quad.easeOut })
    .from(thisPath2.node, .5, { strokeDashoffset: strokeMaskLength2, ease: Quad.easeOut }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['lastfmIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(thisPath1.node, .7, { strokeDashoffset: strokeMaskLength1, ease: Quad.easeOut })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['linkedinIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".i").node, .2, { scaleY: 0, ease: Quad.easeOut, transformOrigin: "top" }, "-=.1")
    .from(f.select(".iDot").node, .2, { scale: 0, y: -25, ease: Quad.easeOut, transformOrigin: "50% 50%" })
    .from(f.select(".n").node, .4, { alpha: 0, ease: easeSocialVar })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['myspaceIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".body1").node, .3, { scaleY: 0, transformOrigin: "bottom", ease: easeSocialVar }, "-=.2")
    .from(f.select(".head1").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".body2").node, .3, { scaleY: 0, transformOrigin: "bottom", ease: easeSocialVar }, "-=.2")
    .from(f.select(".head2").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".body3").node, .3, { scaleY: 0, transformOrigin: "bottom", ease: easeSocialVar }, "-=.2")
    .from(f.select(".head3").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['picassaIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".part1").node, .4, { alpha: 0, ease: easeSocialVar })
    .from(f.select(".part2").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".part3").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.25")
    .from(f.select(".part4").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".part5").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .from(f.select(".allParts").node, 1, { rotation: -40, ease: Quad.easeOut, transformOrigin: "50% 50%" }, "-=1")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['quoraIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".q").node, .5, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['rssIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".dot").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.1")
    .from(f.select(".line1").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".line2").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['sharethisIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".ball1").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.1")
    .from(f.select(".ball2").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.1")
    .from(f.select(".line1").node, .3, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".ball3").node, .3, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".line2").node, .3, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['skypeIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".cloud").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.1")
    .from(f.select(".s").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['soundcloudIcon'] = function (index, f, thisIcon) {
  //animate in animation
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: Back.easeOut })
    .from(f.select(".c1").node, .4, { scaleY: 0, transformOrigin: "bottom", ease: Back.easeSocialVar }, ".3")
    .from(f.select(".c2").node, .3, { scaleY: 0, transformOrigin: "bottom", ease: Back.easeSocialVar }, ".3")
    .from(f.select(".c3").node, .5, { scaleY: 0, transformOrigin: "bottom", ease: Back.easeSocialVar }, ".3")
    .from(f.select(".c4").node, .7, { scaleY: 0, transformOrigin: "bottom", ease: Back.easeSocialVar }, ".3")
    .from(f.select(".c5").node, .3, { scaleY: 0, transformOrigin: "bottom", ease: easeSocialVar }, ".3")
    .from(f.select(".c6").node, .4, { alpha: 0, ease: easeSocialVar }, ".6")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.3")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['technoratiIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".q").node, .5, { scale: 0, transformOrigin: "top right", ease: easeSocialVar }, "-=.1")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['tumblrIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".t").node, .8, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.4")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['twitterIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".bird").node, .5, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['vimeoIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".v").node, .8, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.4")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['wikipediaIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".w").node, .5, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['yahooIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".y").node, .5, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.3")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar })
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['youtubeIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(f.select(".tube").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar }, "-=.1")
    .from(f.select(".triangle").node, .4, { scale: 0, transformOrigin: "0% 50%", ease: easeSocialVar }, "-=.2")
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
window['zerplyIcon'] = function (index, f, thisIcon) {
  ...
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .from(f.select(".bg").node, .4, { scale: 0, transformOrigin: "50% 50%", ease: easeSocialVar })
    .from(thisPath1.node, .8, { strokeDashoffset: strokeMaskLength1, ease: Quad.easeOut })
    .from(f.select(".shadow").node, .4, { alpha: 0, ease: easeSocialVar }, "-=.2")
    .timeScale(speed);
  tls[index] = tl;
  var tlRollover = gsap.timeline();
...
var easeVar = Elastic;
//animate each of the icons
window['chromeIcon'] = function (index, f, thisIcon) {
  //animate in animation
  //f.attr({visibility:"visible"});
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .timeScale(speed)
    .from(f.select(".blue").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut })
    .from(f.select(".white").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.8")
    .from(f.select(".colors").node, 2, { scale: 0, rotation: -1500, transformOrigin: "65 65", ease: Back.easeOut }, "-=1.8");
  tls[index] = tl;
  var tlRollover = gsap.timeline()
    .to(f.select(".blueR").node, .05, { scale: .8, transformOrigin: "50% 50%" })
    .to(f.select(".blueR").node, 1, { scale: 1, ease: easeVar.easeOut })
    .to(f.select(".whiteR").node, .05, { scale: 1.2, transformOrigin: "50% 50%" }, .05)
    .to(f.select(".whiteR").node, 1, { scale: 1, ease: easeVar.easeOut }, .1)
    .to(f.select(".colorsR").node, .05, { transformOrigin: "50% 50%", rotation: "-30" }, 0)
    .to(f.select(".colorsR").node, 1, { rotation: "0", ease: easeVar.easeOut }, .05);
  tlsRollover[index] = tlRollover;
}
window['firefoxIcon'] = function (index, f, thisIcon) {
  //f.attr({visibility:true});
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .timeScale(speed)
    .from(f.select(".blue").node, 2, { alpha: 0, scale: .7, transformOrigin: "50% 50%", ease: easeVar.easeOut })
    .from(f.select(".fox").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.7");
  tls[index] = tl;
  var tlRollover = gsap.timeline()
    .to(f.select(".foxR").node, .05, { transformOrigin: "50% 50%", rotation: "-30" })
    .to(f.select(".foxR").node, 1, { rotation: "0", ease: easeVar.easeOut });
  tlsRollover[index] = tlRollover;
}
window['explorerIcon'] = function (index, f, thisIcon) {
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .timeScale(speed)
    .from(f.select(".blue").node, 2, { alpha: 0, scale: .7, transformOrigin: "50% 50%", ease: easeVar.easeOut })
    .from(f.select(".e").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.7")
    .from(f.select(".halo").node, 2, { scale: .6, alpha: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.7");
  tls[index] = tl;
  var tlRollover = gsap.timeline()
    .to(f.select(".logo").node, .05, { scale: 1.2, transformOrigin: "50% 50%" })
    .to(f.select(".logo").node, 1, { scale: 1, ease: easeVar.easeOut })
  tlsRollover[index] = tlRollover;
}
window['operaIcon'] = function (index, f, thisIcon) {
  //f.attr({visibility:true});
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .timeScale(speed)
    .from(f.select(".oRed").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut })
    .from(f.select(".o").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.7")
    .from(f.select(".red").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.8");
  tls[index] = tl;
  var tlRollover = gsap.timeline()
    .to(f.select(".oRedG").node, .05, { scale: 1.2, transformOrigin: "50% 50%" })
    .to(f.select(".oRedG").node, 1, { scale: 1, ease: easeVar.easeOut })
    .to(f.select(".oWhiteG").node, .05, { scale: 1.2, transformOrigin: "50% 50%" }, .05)
    .to(f.select(".oWhiteG").node, 1, { scale: 1, ease: easeVar.easeOut }, .1);
  tlsRollover[index] = tlRollover;
}
window['safariIcon'] = function (index, f, thisIcon) {
  var tl = gsap.timeline({ onStart: animationComplete, onStartParams: [index, true], onReverseComplete: animationComplete, onReverseCompleteParams: [index, false] })
    .timeScale(speed)
    .from(f.select(".blueSmall").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut })
    .from(f.select(".whiteRing").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.7")
    .from(f.select(".blue").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.8")
    .from(f.select(".gray").node, 2, { alpha: 0, scale: .8, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=1.9")
    .from(f.select(".points").node, 2, { scale: 0, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=2")
    .from(f.select(".compass").node, 1.5, { scale: 0, rotation: -300, transformOrigin: "50% 50%", ease: easeVar.easeOut }, "-=2");
  tls[index] = tl;
  var tlRollover = gsap.timeline()
    .to(f.select(".compassRollover").node, .05, { transformOrigin: "50% 50%", rotation: "30" })
    .to(f.select(".compassRollover").node, 1, { rotation: "0", ease: easeVar.easeOut });
  tlsRollover[index] = tlRollover;
}
load();