    ...
    var Tween = function (_Animation2) {
      ...
      function Tween(targets, vars, position, skipInherit) {
        ...
        var _this3$vars = _this3.vars,
            ...
            staggerFunc,
            staggerVarsToMerge;
        _this3._targets =  _harness(parsedTargets);// : _warn("GSAP target " + targets + " not found. https://greensock.com", !_config.nullTargetWarn) || [];
        _this3._ptLookup = [];
...
!(function (t, e) {
  ...
  function stringToRawPath(t) {
    ...
    if(!t || !isNaN(P[0]) || isNaN(P[1])) return console.fine(x), _;
    for (e = 0; e < v; e++)
      if(
        ((p = a),
  ...
  y() && gsap.registerPlugin(K), (t.MorphSVGPlugin = K), (t.default = K);
